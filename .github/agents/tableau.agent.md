...
- Site discovery (full inventory via `get_site_topology`)
- Dependency graph construction from lineage metadata
- Permission matrix → RLS role mapping
- Extract refresh → PBI scheduled refresh
