    ...
    def test_sqlproxy_generates_valid_m(self):
        conn = {
            ...
            "details": {
                ...
                "port": "443",
                "dbname": "SamplePublishedDatasource",
                "channel": "https",
                "server_ds_name": "SamplePublishedDatasource",
            },
        }
        ...
        self.assertIn("tableau.example.com", result)
        self.assertIn("SamplePublishedDatasource", result)
