...
class TestDaxRoundTrip(unittest.TestCase):
    ...
    def test_lod_fixed_dim_is_calculation_falls_back_to_all(self):
        ...
        Regression for a real-world measure ``Observations_par_confo_%_total``.
        """
        ...
        result = self._convert(
            formula,
            table_name='SAMPLE_OBSERVATION (2)',
            calc_map=calc_map,
        )
    ...
    def test_lod_fixed_cross_table_dim_not_wrapped_with_related(self):
        ...
        # column lives on table 'SAMPLE_OBSERVATION (2)' but the measure
        # is hosted on table 'SAMPLE_OBSERVABLE (2)'.
        calc_map = {'Calculation_5345139495278407692': 'Service ou Entreprise'}
        column_table_map = {
            'Service ou Entreprise': 'SAMPLE_OBSERVATION (2)',
            'ID': 'SAMPLE_OBSERVABLE (2)',
        }
        formula = (
            'COUNT([ID]) / '
